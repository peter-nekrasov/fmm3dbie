...
%
%  Syntax
%   A = bh2d.b2v_matgen_dir(S,zk,targinfo,zpars,eps)
%
...
%
    ...
    mex_id_ = 'getnearquad_bh2d_b2v_dir(i int[x], i int[x], i int[x], i int[x], i int[x], i double[xx], i double[xx], i int[x], i int[x], i double[xx], i int[x], i double[xx], i double[x], i dcomplex[x], i int[x], i int[x], i int[x], i int[x], i int[x], i double[x], i int[x], io double[xx])';
