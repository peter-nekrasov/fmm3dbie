...
%CHNK.BH2D.KERN standard Biharmonic layer potential kernels in 2D
%
% Syntax: submat = kern(zk,srcinfo,targinfo,type,varargin)
...
case {'sp', 'sprime'}
    ...
    [~,grad] = chnk.flex2d.bhgreen(src,targ);
...
% single layer
case {'s', 'single'}
    submat = chnk.flex2d.bhgreen(src,targ);
