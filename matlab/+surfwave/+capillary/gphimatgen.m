function A = gphimatgen(S, zpars, eps)
%
%  surfwave.capillary.gphimatgen
%
%  Syntax
%   A = surfwave.gphimatgen(S,zpars,eps)
%
...
%
    ...
    rfac0 = 1.25;
    nquad = npts*npts;
      mex_id_ = 'getnearquad_capillary_gphi(i int[x], i int[x], i int[x], i int[x], i int[x], i double[xx], i double[xx], i double[x], i dcomplex[x], i int[x], i int[x], i int[x], i int[x], i int[x], i double[x], i int[x], io dcomplex[xx])';
