...
Av2b = flex2d.v2b_matgen_neu(S,zk,targinfo,1e-8);

h = 1e-6;
targinfo2 = []; targinfo2.r = targinfo.r + h*(0:2).*targinfo.n;

Aeval = flex2d.v2b_matgen_dir(S,zk,targinfo2,1e-8);
...
Av2bsupp = flex2d.v2b_matgen_supp2(S,zk,nu,targinfo,eps);

Aeval = flex2d.v2b_matgen_dir(S,zk,bctarginfo,1e-8);
...
Av2bfree = flex2d.v2b_matgen_free2(S,zk,nu,targinfo,eps);
