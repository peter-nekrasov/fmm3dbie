...
!
      ...
      subroutine getnearquad_modified_flex2d_gv2v(npatches, norders, &
...
!$OMP END PARALLEL DO      
      ...
      return
      end subroutine getnearquad_modified_flex2d_gv2v
!
!
!
!
!
      subroutine getnearquad_modified_flex2d_dir(npatches, norders, &
...
!
!
      subroutine getnearquad_modified_flex2d_neu(npatches, norders, &
        ixyzs, iptype, npts, srccoefs, srcvals, ndtarg, ntarg, targs, &
        ipatch_id, uvs_targ, eps, zpars, iquadtype, nnz, row_ptr, &
        col_ind, iquad, rfac0, nquad, wnear)
!
